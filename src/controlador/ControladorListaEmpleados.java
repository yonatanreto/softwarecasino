 ...
 * @author Usuario
 */
public class ControladorListaEmpleados implements ActionListener , Runnable, MouseListener,KeyListener,MouseMotionListener{
            JFListaEmpleados vistaLista;
    ...
    public ControladorListaEmpleados(JFListaEmpleados vistaLista) {
            this.vistaLista = vistaLista;
            this.modeloDAO = new  EmpleadosDAO(Conexion.f);
    ...
    public void configurarTabla(){
         ...
         vistaLista.tabla.getColumnModel().getColumn(0).setPreferredWidth(30);
         vistaLista.tabla.getColumnModel().getColumn(1).setPreferredWidth(180);
         vistaLista.tabla.getColumnModel().getColumn(2).setPreferredWidth(180);
         vistaLista.tabla.getColumnModel().getColumn(3).setPreferredWidth(180);
    ...
    public void run(){
		try {
                   ...
                   configurarTabla();
                    ...
                    List  listaObjetoVO=(List) modeloDAO.findEmpleadosEntities();
                    LogicaGeneral.setListaEntidad("Empleados",listaObjetoVO);
                   ////[Usuario], [Tipo]
                   for(int i=0;i<listaObjetoVO.size();i++){
                        Empleados objetoVO_aux=(Empleados) listaObjetoVO.get(i);
                        Object fila[]=new Object[4];
                        fila[0]=" "+objetoVO_aux.getCedula();
                        fila[1]=" "+objetoVO_aux.toString();     
                        fila[2]=" "+objetoVO_aux.getCargo().getNombre();   
                        fila[3]=" "+objetoVO_aux.getAreaDeTrabajo().getNombre();   
                       dtm.addRow(fila);
                   }           
		 ...
		 Logger.getLogger(ControladorListaEmpleados.class.getName()).log(Level.SEVERE, null, ex);
                 ex.printStackTrace();
   ...
   //Este metodo obtiene el objetoVO selecccionado en la Tabla.
    public Empleados getObjetoVOSeleccionado(){   
     return objetoVO=(Empleados)LogicaGeneral.getListaEntidad("Empleados").get(ControladorGeneral.filaSeleccionada(select,vistaLista.tabla));
   }
    ...
    public void actionPerformed(ActionEvent e) {
            ...
            if(e.getSource()==vistaLista.btnSalir){
                 ControladorGeneral.salirVista("ListaEmpleados", vistaLista);
